...
<head>
    ...
    <link rel="stylesheet" href="style/late.css">
...
<body>
    ...
    <script type="text/javascript">
            ...
            function latepending(){
            $.ajax({
                type: "GET",
                url: "backend/latepending.php?token=1",
                dataType: "html",
            ...
            $.ajax({
                type: "GET",
                url: "backend/latedone.php?token=1",
                dataType: "html",
                success:function(response){
        ...
        function get_finished_all_task(){
            $.ajax({
                type: "GET",
                url: "backend/lateT.php?get_task=1",
                dataType: "html",
                success:function(response){
