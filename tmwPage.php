...
<body>
    <div id="container">
        ...
        <div id="body">
            <div id="settings">
                <h2 id="tday" style="color:white;">Tasks Due Tommorow</h2>
                <hr>
        ...
        border-right-style:none;">
            ...
            <div id="today" class="today" onclick="sevendays(window.location.replace('7days.php'))">
    ...
    <script type="text/javascript">
        ...
        function tmw(){
            $.ajax({
                type: 'GET',
                url: 'backend/tommorowDue.php?id='+userID,
                dataType: 'html',
