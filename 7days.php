...
<body>
    <div id="container">
        ...
        <div id="body">
            <div id="settings">
                <h2 id="tday" style="color:white;">Tasks Due in 7 Days</h2>
                <hr>
                <div id="username" style="border-style: none; background-color:#444; margin-bottom:0; margin-top:0;">
                    ...
                    <div id="username3" style="margin-bottom:0; margin-top:0; border-style:none;"><p style="color:white;margin-bottom:0; margin-top:0; font-size:20px;">End Date</p></div>
    ...
    <script type="text/javascript">
        ...
        function sevendays(){
            $.ajax({
                type: 'GET',
                url: 'backend/7daysDue.php?id='+userID,
                dataType: 'html',
